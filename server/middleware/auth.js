...
export default async function Auth(req, res, next) {
    try {
        ...
        // const decodedToken = await jwt.verify(token, ENV.JWT_SECRET);   // for development 
        const decodedToken = await jwt.verify(token, process.env.JWT_SECRET);   // for production  
